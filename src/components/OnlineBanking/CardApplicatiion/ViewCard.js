...
const cards = [
    {  
        ...
        cardType: 'lindsay.walton@example.com', 
        expires: 'Member',
        status: "Pending",
    },
    // More people...
    ...
    return (
      <div className="px-4 sm:px-6 lg:px-8 mt-10">
        <div className="block bg-slate-900 p-2">
          <div className="">
            <h1 className="text-xl font-semibold text-blue-100 ">Card</h1>
          </div>
            ...
            <tbody className="divide-y divide-gray-200 bg-white">
              {cards.map((card) => (
                <tr key={card.userAccount}>
                  ...
                  <td className=" px-3 py-4 text-sm text-gray-500 sm:table-cell">{card.cardType}</td>
                  <td className=" px-3 py-4 text-sm text-gray-500 sm:table-cell">{card.expires}</td>
